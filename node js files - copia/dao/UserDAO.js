...
function UserDAO(db) {
  ...
  this.addUser = function (username, password, email, grupoAutocodes, callback) {
    ...
    users.findOne({'_id': username}, function (err, user) {
      ...
      if (user) {
        ...
        var user = {'_id': username, 'password': password_hash, 'email': email, 'grupoAutoc': grupoAutocodes};
  ...
  this.obtenerObjetoUsuario = function (username, callback) {
